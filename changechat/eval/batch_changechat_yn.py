    ...
    for i in tqdm(range(0, len(questions), args.batch_size)):
        ...
        for j in range(i, batch_end):
            ...
            qs = (
                ...
                + "\n"
                + qs
                + "Please focus only on obvious changes to buildings and roads, and ignore grass and vegetation. If only vegetation has changed, or the objects that have changed are small, then answer no."
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model-path", type=str, default="experiments/changechat-lora-0727"
    )
