    ...
    for i in tqdm(range(0, len(questions), args.batch_size)):
        ...
        for turn_idx in range(len(QSList)):
            ...
            for j in range(i, batch_end):
                ...
                stop_str = (
                    conv_history[j - i].sep
                    if conv_history[j - i].sep_style != SeparatorStyle.TWO
                    else conv_history[j - i].sep2
                )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--answers-file",
        type=str,
        default="/root/autodl-tmp/LEVIR-MCI-dataset/answer_v3_0701_a.jsonl",
    )
