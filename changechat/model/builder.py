...
def load_pretrained_model(
    ...
    if "changechat" in model_name.lower():
        # Load LLaVA model
        ...
        if "lora" in model_name.lower() and model_base is not None:
            ...
            print("Loading Changechat from base model...")
            ...
            print("Loading additional ChangeChat weights...")
            ...
            print("mm_projector_weights loaded")
        else:
            print("Loading ChangeChat......")
